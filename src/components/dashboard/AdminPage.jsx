...
const adminModules = [
  {
    ...
    description: "Open the full organization settings workspace.",
    icon: "layers",
    action: "open-organization-settings",
    tone: "indigo",
  },
  {
    key: "welfare",
...
export default function AdminPage({
  ...
  const handleModuleClick = (module) => {
    if (module?.action === "open-organization-settings") {
      if (typeof onOpenOrganizationSettings === "function") {
        onOpenOrganizationSettings();
      }
      return;
    }
  ...
  const mobileNavModules = adminModules
    .filter((module) => module.sections?.length || module.action)
    .slice(0, 5);
        ...
        <div className="admin-card admin-launchpad">
          ...
          <div className="admin-launchpad-grid">
            {adminModules.map((module) => {
              const isEnabled = Boolean(module.sections?.length || module.action);
